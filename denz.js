...
try {
        ...
        mess = {
			...
			only: {
				...
				ownerB: 'ᴏɴʟʏ ғᴏʀ ⁩ ī.ᴀᴍ/ꪶ͢ɴɪᴊɪɴ sᴇʀ³³³ꫂ⁩🥂',
				admin: 'ᴏɴʟʏ ғᴏʀ ᴀᴅᴍɪɴ🙂',
				Badmin: 'ᴇɴɴᴇ ɢʀᴏᴜᴘ ᴀᴅᴍɪɴ ᴀᴋᴋᴜ😣'
			}
		}
		...
		const katalog = (teks) => {
             res = denz.prepareMessageFromContent(from,{ "orderMessage": { "itemCount": 777888, "message": teks, "footerText": "*_©☞ɴɪᴊɪɴ sᴇʀ³³³_*", "thumbnail": ofrply, "surface": 'CATALOG' }}, {quoted:ftrol})
             denz.relayWAMessage(res)
        }
        const grupinv = (teks) => { 
        	grup = denz.prepareMessageFromContent(from, { "groupInviteMessage": { "groupJid": '6288213840883-1616169743@g.us', "inviteCode": 'https://chat.whatsapp.com/Dgt6JhzTvlmEor8Zz23fHx', "groupName": `${NamaBot}`, "footerText": "*_© ☞ɴɪᴊɪɴ sᴇʀ³³³_*", "jpegThumbnail": ofrply, "caption": teks}}, {quoted:finv})
		...
		const sekarang = new Date().getTime();
			...
			var ase = new Date();
                        ...
                        switch(waktoo){
               case 0: waktoo = "ᴀʏɪsʜ ᴀʀᴀ ᴀᴛʜᴜ -  ī.ᴀᴍ/ꪶ͢ɴɪᴊɪɴ sᴇʀ³³³ꫂ⁩😌"; break;
                case 1: waktoo = "ᴀʏɪsʜ ᴀʀᴀ ᴀᴛʜᴜ -  ī.ᴀᴍ/ꪶ͢ɴɪᴊɪɴ sᴇʀ³³³ꫂ⁩😌"; break;
                case 2: waktoo = "ᴀʏɪsʜ ᴀʀᴀ ᴀᴛʜᴜ -  ī.ᴀᴍ/ꪶ͢ɴɪᴊɪɴ sᴇʀ³³³ꫂ⁩😌"; break;
                case 3: waktoo = "ᴀʏɪsʜ ᴀʀᴀ ᴀᴛʜᴜ -  ī.ᴀᴍ/ꪶ͢ɴɪᴊɪɴ sᴇʀ³³³ꫂ⁩😌"; break;
                case 4: waktoo = "ᴀʏɪsʜ ᴀʀᴀ ᴀᴛʜᴜ - -  ī.ᴀᴍ/ꪶ͢ɴɪᴊɪɴ sᴇʀ³³³ꫂ⁩😌"; break;
                case 5: waktoo = "ᴀʏɪsʜ ᴀʀᴀ ᴀᴛʜᴜ - -  ī.ᴀᴍ/ꪶ͢ɴɪᴊɪɴ sᴇʀ³³³ꫂ⁩😌"; break;
                case 6: waktoo = "ᴀʏɪsʜ ᴀʀᴀ ᴀᴛʜᴜ\n-  ī.ᴀᴍ/ꪶ͢ɴɪᴊɪɴ sᴇʀ³³³ꫂ⁩😌"; break;
                ...
                case 19: waktoo = "ᴀʏɪsʜ ᴀʀᴀ ᴀᴛʜᴜ - -  ī.ᴀᴍ/ꪶ͢ɴɪᴊɪɴ sᴇʀ³³³ꫂ⁩😌"; break;
                case 20: waktoo = "ᴀʏɪsʜ ᴀʀᴀ ᴀᴛʜᴜ - -  ī.ᴀᴍ/ꪶ͢ɴɪᴊɪɴ sᴇʀ³³³ꫂ⁩😌"; break;
                case 21: waktoo = "ᴀʏɪsʜ ᴀʀᴀ ᴀᴛʜᴜ - -  ī.ᴀᴍ/ꪶ͢ɴɪᴊɪɴ sᴇʀ³³³ꫂ⁩😌"; break;
...
denz.sendMessage(id, buttonMessages, MessageType.buttonsMessage, options)
 ...
 if (!mek.key.remoteJid.endsWith('@g.us') && offline){
		  ...
		  sendButMessage(from, `Hai ${pushname}, Sorry it seems at this time ${NamaOwner} currently Offline\n\n*Reason :* ${alasanafk}\n*Since :* ${heheh.hours} Hour, ${heheh.minutes} Minutes, ${heheh.seconds} second\n\nPlease contact again after Online`, "*_©☞ɴɪᴊɪɴ sᴇʀ³³³_*", [{buttonId: 'simi', buttonText: {displayText: 'Oke'}, type: 1}], {quoted:ftrol, contextInfo: { forwardingScore: 508, isForwarded: true}})
			}
		}
		if (mek.key.remoteJid.endsWith('@g.us') && offline) {
			if (!mek.key.fromMe){
		...
		const reply = (teks) => {
			denz.sendMessage(from, teks, text, { thumbnail: dfrply, sendEphemeral: true, quoted: mek, contextInfo: { forwardingScore: 508, isForwarded: true, externalAdReply:{title: `ꪶ͢ɴɪᴊɪɴ sᴇʀ³³³ꫂ⁩`,body:"",previewType:"PHOTO",thumbnail:ofrply,sourceUrl:`https://wa.me/919446672120?text=Hi bro`}}})
		}
		const reply2 = (teks) => {
 ...
 {denz.sendMessage(from, tlsm(), text, {quoted: mek})}} 	
			...
			for (let anji of setik){
				if (budy === anji){
					...
					denz.sendMessage(from, result, sticker, { quoted: { key: { fromMe: false, participant: `0@s.whatsapp.net`, ...(from ? { remoteJid: "status@broadcast" } : {})}, message: { orderMessage: { itemCount: 9999999, status: 200, thumbnail: fs.readFileSync('./denz.jpg'), surface: 200, message: `✘ ꪶ͢ɴɪᴊɪɴ sᴇʀ³³³ꫂ⁩✘ ➫➬➭ ${anji}`, orderTitle: `𒈒 ꪶ͢ɴɪᴊɪɴ sᴇʀ³³³ꫂ⁩ 𒈒➫➬➭ ${anji}`, sellerJid: '0@s.whatsapp.net'}}}})
					}
			}
			for (let anju of vien){
				if (budy === anju){
					result = fs.readFileSync(`./media/vn/${anju}.mp3`)
					denz.sendMessage(from, result, audio, { quoted: { key: { fromMe: false, participant: `0@s.whatsapp.net`, ...(from ? { remoteJid: "status@broadcast" } : {})}, message: { orderMessage: { itemCount: 9999999, status: 200, thumbnail: fs.readFileSync('./denz.jpg'), surface: 200, message: `✘ ꪶ͢ɴɪᴊɪɴ sᴇʀ³³³ꫂ⁩✘ ➫➬➭ ${anju}`, orderTitle: `𒈒 ꪶ͢ɴɪᴊɪɴ sᴇʀ³³³ꫂ⁩ 𒈒➫➬➭  ${anju}`, sellerJid: '0@s.whatsapp.net'}}}, mimetype: 'audio/mp4', duration: 359996400, ptt: true})
					}
			}
			for (let anjh of imagi){
				if (budy === anjh){
					result = fs.readFileSync(`./media/image/${anjh}.jpg`)
					denz.sendMessage(from, result, image, {quoted: { key: { fromMe: false, participant: `0@s.whatsapp.net`, ...(from ? { remoteJid: "status@broadcast" } : {})}, message: { orderMessage: { itemCount: 9999999, status: 200, thumbnail: fs.readFileSync('./denz.jpg'), surface: 200, message: `✘ ꪶ͢ɴɪᴊɪɴ sᴇʀ³³³ꫂ⁩✘ ➫➬➭ ${anjh}`, orderTitle: `𒈒 ꪶ͢ɴɪᴊɪɴ sᴇʀ³³³ꫂ⁩𒈒➫➬➭ ${anjh}`, sellerJid: '0@s.whatsapp.net'}}}})
					}
			}
...
☯ 𝙳𝙰𝚈 : ${week} ${weton}
☯ 𝙳𝙰𝚃𝙴 : ${calender}`
sendButLocation(from, `${menu}`, "ꪶ͢ɴɪᴊɪɴ sᴇʀ³³³ꫂ⁩", {jpegThumbnail:gambar,name:""}, [
{buttonId:`allmenu`,buttonText:{displayText:'ᴍᴇɴᴜ'},type:1},
{buttonId:`owner`,buttonText:{displayText:'ᴏᴡɴᴇʀ'},type:1},
{buttonId:`script`,buttonText:{displayText:'sᴄʀɪᴘᴛ'},type:1}
...
╚༄ ${prefix}sᴇᴅ ʟʏғᴇ
 ╔༆
 ║ ғᴏʟʟᴏᴡ ᴍᴇ ᴏɴ ɪɴsᴛᴀɢʀᴀᴍ:https://instagram.com/ɴɪᴊɪɴ_𝟹𝟹𝟹
 ╚༄
╔✘*ᴛʀʏ ᴀɴʏ ᴛʜɪɴɢ✘
║༊ ${prefix}ᴏᴡɴᴇʀᴍᴇɴᴜ
║༊ ${prefix}ᴍᴀᴋᴇʀᴍᴇɴᴜ
...
༆☞ɴɪᴊɪɴ⁴⁰⁴༄
ʟᴏᴠᴇ ʏᴏᴜ ᴀʟʟ!`
sendButLocation(from, `${menu}`, "©☞ɴɪᴊɪɴ sᴇʀ³³³", {jpegThumbnail:gambar,name:""}, [{buttonId:`about`,buttonText:{displayText:'ᴀʙᴏᴜᴛ'},type:1},{buttonId:`script`,buttonText:{displayText:'ɢɪᴛ'},type:1}], {contextInfo: { mentionedJid: [otod]}})
break
case 'alive':
denz.sendMessage(from, 'ᴡᴀɪᴛ ʙʀᴏ🙂', text, {quoted: ftok})
stst = await denz.getStatus(`${sender.split('@')[0]}@c.us`)
...
┗━━━━━━━━━━━━━━━𒈒
         ī.ᴀᴍ/ꪶ͢ɴɪᴊɪɴ sᴇʀ³³³ꫂ⁩`
sendButLocation(from, `${menu}`, "©☞ɴɪᴊɪɴ sᴇʀ³³³", {jpegThumbnail:gambar,name:""}, [{buttonId:`menu`,buttonText:{displayText:'ᴍᴇɴᴜ'},type:1},{buttonId:`credit`,buttonText:{displayText:'ᴄʀᴇᴀᴛᴏʀ'},type:1}], {contextInfo: { mentionedJid: [otod]}})
break
case 'menu':
case 'p':
...
╚༄ᴏᴡɴᴇʀ⟼ @${dtod.split('@919446672120')[0]}             
${tampilUcapan}
${" "}
...
//Now
case 'nuliskiri':
if (!c) return reply('Where 𝚒s the text bro?')
reply(mess.wait)
...
╰───────────────𒈒
 ...
 `
     credit = denz.prepareMessageFromContent(from,{ "orderMessage": { "itemCount": 8888888, "message": `${yez}`, "footerText": "©☞ɴɪᴊɪɴ sᴇʀ³³³", "thumbnail": fs.readFileSync('./denz.jpg'), "surface": 'CATALOG'}}, {quoted: mek})
...
┃𒈒 *ɴᴀᴍᴇ ʙᴏᴛ* :  ī.ᴀᴍ/ꪶ͢ɴɪᴊɪɴ sᴇʀ³³³ꫂ⁩
┃𒈒 *ɴᴀᴍᴇ ᴏᴡɴᴇʀ* : ☞ɴɪᴊɪɴ sᴇʀ³³³
┃𒈒 *ᴄʀᴇᴀᴛᴏʀ* : @919446672120
┃𒈒 *sᴘᴇᴇᴅ* : 00065
┗━━𒆜`, MessageType.text, {contextInfo: { forwardingScore: 508, isForwarded: true, externalAdReply:{title: " ī.ᴀᴍ/ꪶ͢ɴɪᴊɪɴ sᴇʀ³³³ꫂ⁩",body:"",previewType:"PHOTO",thumbnail:fs.readFileSync('./denz.jpg')}}})
break
case 'donate':
...
Giliran = @${tty.player1.split('@')[0]}`
 denz.sendMessage(from, ucapan, text, {quoted: mek, contextInfo:{mentionedJid: [tty.player1,tty.player2]}})
     ...
     denz.sendMessage(`${settings.NomorOwner}@s.whatsapp.net`, `─────「 *ᴇʀʀᴏʀ-ᴀʟᴇʀᴛ* 」─────\n\n\`\`\`${e}\`\`\`\n\n────────────────────`, MessageType.text, {contextInfo: { forwardingScore: 508, isForwarded: true, externalAdReply:{title: "ꪶ͢ɴɪᴊɪɴ sᴇʀ³³³ꫂ⁩",body:"",previewType:"PHOTO",thumbnail:fs.readFileSync('./denz.jpg'),sourceUrl:"https://wa.me/919446672120?text=Hi Bro"}}})
	}
    }
    }
    }
